...
import { formatDate, formatDateTimeFull } from '../../utils/date.util';
  ...
  if (options.includeHeader) {
    ...
    <div class="header">
      ...
      <div class="form-info">
        ...
        ${form.completedDate ? `<span>Completed: ${formatDate(form.completedDate)}</span>` : ''}
  ...
  if (options.includeFooter) {
    ...
    <div class="footer">
      <div class="footer-left">
        Printed: ${formatDateTimeFull(new Date())}
      </div>
...
`;
  ...
  <div class="cover-page">
    ...
    <div class="cover-info">
      ...
      <p><strong>Enrollment Date:</strong> ${formatDate(casebook.enrollmentDate)}</p>
      <p><strong>Status:</strong> ${casebook.status}</p>
    </div>
    <div class="generated-info">
      <p>Generated: ${formatDateTimeFull(casebook.generatedAt)}</p>
  ...
  for (const event of casebook.events) {
    ...
    <div class="event-section">
      ...
      <p class="event-info">
        Date: ${event.eventDate ? formatDate(event.eventDate) : 'Not scheduled'}
        | Status: ${event.status}
      </p>
    `;
...
<body>
  <div class="header">
    ...
    <div class="audit-info">
      ...
      <p><strong>Generated:</strong> ${formatDateTimeFull(auditTrail.generatedAt)}</p>
...
`;
  ...
  for (const entry of auditTrail.entries) {
    html += `
      <tr>
        <td>${formatDateTimeFull(entry.auditDate)}</td>
        <td>${entry.action}</td>
